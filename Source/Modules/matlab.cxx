...
void MATLAB::initGateway() {
  ...
  Printf(f_gateway,"    SWIG_Matlab_Error(\"This mex file should only be called from inside the .m files generated by SWIG. First input should be the function ID .\");\n");
